...
insert into Users (firstName, lastName, email, username, thepassword, phone, zipcode, party, office, description) values ('Gregorio', 'Rudham', 'grudham4@loc.gov', 'asdf', 'asdf', '995-496-1886', '28002', 'independent', 'Senator', 'encoding');
